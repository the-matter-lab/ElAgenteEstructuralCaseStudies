...
- `endpoint_only_prompt.txt` is the exact prompt used for the Claude Opus 4.5
...
- The Claude Opus 4.5 JSON file contains its native benchmark telemetry,
  including responses, failures, generated files, token usage, timing, and
  process data.
